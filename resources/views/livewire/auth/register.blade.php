                            ...
                            <div
                                ...
                                <div class="card card-plain">
                                    <div class="card-header">
                                        ...
                                        <p class="mb-0">Ingrese sus datos para registrarse</p>
                                    </div>
                                    <div class="card-body">
                                        <form wire:submit.prevent ="store">
                                            ...
                                            <div class="form-check form-check-info text-start ps-0 mt-3">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Estoy deacuerdo con los <a href="javascript:;"
                                                        class="text-dark font-weight-bolder">Terminos y condiciones</a>
                                                </label>
                                            </div>
                                            <div class="text-center">
                                                <button type="submit"
                                                    class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Registrarce
                                                    </button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p class="mb-2 text-sm mx-auto">
                                            Ya tienes cuenta?
                                            <a href="{{ route('login') }}"
                                                class="text-primary text-gradient font-weight-bold">Loguearce</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
